  ...
  public getDefinition(): McpToolDefinition {
    return {
      ...
      meta: {
        ...
        description:
          "Use this when you need to save a new subscription or update an existing one (including canceling by setting an end date). Do not use for deleting subscriptions.",
