...
import { UpdateInterestRateToolSchema } from "../../../schemas/mcp-bank-account-interest-rates-schemas.ts";
  ...
  public getDefinition(): McpToolDefinition {
    return {
      ...
      meta: {
        ...
        inputSchema: UpdateInterestRateToolSchema.shape,
        annotations: {
          readOnlyHint: false,
      ...
      run: async (input: unknown) => {
        const parsed = UpdateInterestRateToolSchema.parse(input);
