  ...
  public getDefinition(): McpToolDefinition {
    return {
      ...
      meta: {
        ...
        description:
          "Use this when you need to retrieve the balance history for bank accounts with optional sorting and pagination. You can optionally specify a bankAccountId to filter by a specific account, or omit it to retrieve all balances across all accounts.",
