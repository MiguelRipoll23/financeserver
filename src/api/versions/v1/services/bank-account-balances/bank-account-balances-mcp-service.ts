...
import { EditBalanceToolService } from "./tools/edit-balance-tool-service.ts";
...
export class BankAccountBalancesMCPService {
  constructor(
    ...
    private editBalanceToolService = inject(EditBalanceToolService),
  ...
  public getTools(): McpToolDefinition[] {
    return [
      ...
      this.editBalanceToolService.getDefinition(),
