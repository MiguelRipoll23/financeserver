  ...
  public getDefinition(): McpToolDefinition {
    return {
      ...
      meta: {
        title: "Update bill",
        description:
          "Use this when you need to update an existing bill. You can update any combination of fields (date, category, total amount, currency code, sender email). Only provide the fields you want to change. Do not use for creating new bills or deleting bills.",
