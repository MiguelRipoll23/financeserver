  ...
  public getDefinition(): McpToolDefinition {
    return {
      ...
      meta: {
        title: "Update bill",
        description:
          "Use this when you need to update an existing bill with new date, category, total amount, and optional sender email. Do not use for creating new bills or deleting bills.",
