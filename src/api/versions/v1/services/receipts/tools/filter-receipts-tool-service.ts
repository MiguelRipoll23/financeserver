  ...
  public getDefinition(): McpToolDefinition {
    return {
      ...
      meta: {
        ...
        description:
          "Use this when you need to search receipts by date range, total amounts, or product names. Do not use for creating or updating receipts.",
      ...
      .map((receipt) => {
        ...
        const lines = receipt.items
          .map((item: ReceiptLineItem) => {
            ...
            let itemLine = formatItemLine(item, " •", receipt.currencyCode);
