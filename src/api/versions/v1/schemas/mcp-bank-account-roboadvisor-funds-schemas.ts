...
export const FilterBankAccountRoboadvisorFundsToolSchema = z.object({
  ...
  name: z.string().optional().describe("Filter by fund name (partial match)"),
  isin: z.string().optional().describe("Filter by ISIN code"),
  assetClass: z.string().optional().describe("Filter by asset class"),
